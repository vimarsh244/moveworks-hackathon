...
<template>
	<div class="max-w-xl mx-auto text-black">
	  <h1 class="my-8 text-5xl font-bold text-center">Moveworks ChatBot</h1>
	  <div class="max-w-xl mx-auto">
		<div class="bg-purple-200 rounded-md shadow h-[60vh] flex flex-col justify-between">
		  <div class="h-full overflow-auto chat-messages">
			<div v-for="(message, i) in messages" :key="i" class="flex flex-col p-4">
			  ...
			  <div v-else class="pl-8 ml-auto">
				<div class="p-2 mt-1 text-sm text-white bg-blue-600 rounded-lg">
				  {{ message.message }}
				</div>
			  </div>
			</div>
		  ...
		  <form @submit.prevent="sendPrompt">
			<div class="flex items-center w-full p-4">
			  <input
				...
				class="w-full p-1 text-sm text-white bg-transparent bg-blue-800 border rounded-md shadow border-white/40 grow"
			  />
			  <button
				:disabled="loading"
				type="submit"
	  ...
	  <div class="flex flex-col justify-center w-full my-4">
		<div class="flex items-center justify-center my-2">
		  ...
		  <a
			...
			class="flex items-center mx-1 font-medium underline transition-colors underline-offset-4 hover:text-white/70"
		  >
			<p class="text-blue-400">gpt-3</p>
		  </a>
		  ...
		  >
			...
			<p class="text-blue-400">Nuxt</p>
		  </a>
		  .
		</div>
		<div class="flex flex-col items-center justify-center">
		  <a href="https://vercel.com">
			<img src="/vercel.svg" alt="Vercel Logo" class="h-4 my-2 text-blue-400" />
		  </a>
		  <a
		  ...
		  >
			...
			<p class="ml-1 text-blue-400">Source</p>
		  </a>
		</div>
	  </div>
	</div>
...
<template>
	<div class="max-w-xl mx-auto text-black">
		...
		<h1 class="my-8 text-5xl font-bold text-center text-black">Moonworks Hack-AI-thon</h1>
		<div class="max-w-xl mx-auto">
