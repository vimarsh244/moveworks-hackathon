# https://www.moveworks.com/insights/forms-brought-service-catalog-to-life
...
![service catalog form | SERVICE CATALOG All Services 63 Items Popular v Hardware New Computer Request Monthly Server Maintenance New Cell Phone Request New Monitor Request Building Maintenance Large Item Pickup Broken Door Fire alarm reset Information Technology Select Model Select Model Select Model Location ~ Building ~ View All “required “required “required View All “required “required View All Applications Password Reset New User Access Request Email Address Change Software Access Request Distribution List Request Invite External Guest to Slack Channel Office Kitchen Cleaning Request Travel Expense Reports Office Supply Request Onboarding Documents Human Resources Lee W ne aie Ea ore Q View All Mac PC View All Location ~ * required Department ¥ | ‘required View All Cetra MA along](https://www.moveworks.com/hs-fs/hubfs/Content_Image_fig01.png)
...
![Content_Image_02_Condensed-1](https://www.moveworks.com/hs-fs/hubfs/Content_Image_02_Condensed-1.gif?&name=Content_Image_02_Condensed-1.gif)
...
![surface the right form | ¥ Chelsea Hey — | just started today, and need access to the latest budget? | don't even know where to start. Moveworks Ok, it looks like you need access to the shared marketing folder. Would you like to fill out a form for access to Dropbox now? Dropbox Access | Fill this form Chelsea Yes, please! Thank you!!](https://www.moveworks.com/hs-fs/hubfs/Content_Image_03.png)
...
![service catalog forms | 1.72" Average time for Moveworks to find and deliver the right form to an employee](https://www.moveworks.com/hs-fs/hubfs/Content-Stat-01-2.png)
...
![forms personalization | ¥ ¥ ¥ Drew Just started work today — can | get access to MS Office? Moveworks Okay, it looks like you need MS Office. Only 1 field is missing. Please provide a business justification. Business Justification Please type your answer below. | Fill this form Drew | need to build a pitch deck for tomorrow's event. Moveworks Ok, | understand you need MS Office, but this requires manager approval. v | have reached out to @Helene Baker to get MS Office approval for you. I’ll let you know when it’s approved. Moveworks Your access to MS Office has been approved. Click here to download. Drew So fast! Thanks!](https://www.moveworks.com/hs-fs/hubfs/Content_Image_04.png)
...
![smart forms completion rate | 46°: Increase in form completion with Moveworks Smart Forms](https://www.moveworks.com/hs-fs/hubfs/Content-Stat-02-2.png)
...
![Content_Image_05-1 | Forms: Catalog Effectiveness Current ) Effectiveness Projected Effectiveness Software Access Request Form Distribution List Request Form Shared Network Folder Access Form Request Hardware Accessory Form Extend Contractor Account Form Salesforce Account Request Form Privileged Access Requests Form Invite External Guest to Slack Channel Form](https://www.moveworks.com/hs-fs/hubfs/Content_Image_05-1.jpg)
...
![smart forms resolution | @ Faster autonomous resolution with Moveworks Smart Forms fi](https://www.moveworks.com/hs-fs/hubfs/Content-Stat-03-2.png)
...
![smart forms | Forms served to employees every week: 3.7x increase since 2020 4000 3000 2000 Sessions 1000 0 2020-01-01 2020-03-01 2020-05-01 2020-07-01 2020-09-01 2020-11-01 Week](https://www.moveworks.com/hs-fs/hubfs/Content_Image_06.jpg)
